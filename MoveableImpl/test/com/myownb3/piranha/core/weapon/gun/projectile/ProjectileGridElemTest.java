...
class ProjectileGridElemTest {
   ...
   void testOnCollision_Twice_RemoveDestroyedProjectile() {
      ...
      projectileGridElementent.onCollision(Collections.singletonList(mock(Obstacle.class)));// second time
   ...
   @Test
   void testOnCollision_Twice_NotRemoveDestroyedSinceNotDestroyedProjectile() {
