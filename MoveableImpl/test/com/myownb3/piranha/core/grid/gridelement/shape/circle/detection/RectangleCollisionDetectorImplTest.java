...
import com.myownb3.piranha.core.grid.gridelement.shape.PathSegment;
...
class RectangleCollisionDetectorImplTest {
   ...
   void testCheckCollision_NoCollision() {
      ...
      // When
      tcb.collisionDetector.checkCollision(tcb.collisionDetectionHandler, tcb.movedGridElement, tcb.oldPosition, tcb.newPosition, tcb.allObstacles);
   ...
   private Obstacle mockObstacle(Position position) {
      ...
      when(pathSegment.getBeginPosition()).thenReturn(position);
   ...
   private static class TestCaseBuilder {
      ...
      private List<GridElement> allObstacles;
