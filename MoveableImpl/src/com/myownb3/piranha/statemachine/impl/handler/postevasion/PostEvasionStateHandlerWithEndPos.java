...
/**
 * The {@link PostEvasionStateHandlerWithEndPos} implements a
 * {@link EvasionStatesHandler} for the {@link EvasionStates#POST_EVASION} with
 * a known end-point to return to
 * 
 * @author Dominic
 *
 */
public class PostEvasionStateHandlerWithEndPos extends CommonStateHandlerImpl<PostEvasionEventStateInput>{
    ...
    public PostEvasionStateHandlerWithEndPos(Position endPos, double stepWidth) {
