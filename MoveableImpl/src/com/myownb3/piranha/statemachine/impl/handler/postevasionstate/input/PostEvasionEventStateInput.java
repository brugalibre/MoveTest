...
public class PostEvasionEventStateInput extends CommonEventStateInput {
    ...
    private PostEvasionEventStateInput(Grid grid, DetectableMoveableHelper helper, Moveable moveable, Position positionBeforeEvasion, Position endPosition) {
     ...
     *            the {@link Position} the moveable had before the evasion
     * @param endPosition
     *            the end-position
     * @return a {@link PassingEventStateInput}
     */
    public static PostEvasionEventStateInput of(DetectableMoveableHelper helper, Grid grid, Moveable moveable, Position positionBeforeEvasion, Position endPosition) {
