...
public class MoveableLauncher {
	...
	// List<GridElement> gridElements = getAllGridElements(moveables, grid, height,
	// width);
	...
	MainWindow mainWindow = new MainWindow(Collections.singletonList(obstacle), gridElements,
		grid.getDimension().getWidth(), grid.getDimension().getHeight());
	mainWindow.show();
