...
import com.myownb3.piranha.core.battle.weapon.tank.strategy.handler.impl.AlwaysMoveForwardTankStrategyHandler;
   ...
   public TankStrategyHandler createTankStrategyHandler(TankStrategy tankStrategy, TankStrategyHandleInput tankStrategyHandleInput) {
      switch (tankStrategy) {
         case ALWAYS_MOVE_AND_SHOOT:
            return new AlwaysMoveForwardTankStrategyHandler(tankStrategyHandleInput);
